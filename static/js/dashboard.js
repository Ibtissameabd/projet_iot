function setIncidentStatus(isIncident) {
    const status = document.getElementById("statusState");

    if (isIncident) {
        status.className = "status-state incident";
        status.textContent = "Incident en cours";
    } else {
        status.className = "status-state ok";
